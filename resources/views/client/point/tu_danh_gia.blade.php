                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><input type="number" class="form-control" min="0" max="10" name="1a" value=""></td>
                            <td></td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            ...
                            <td><input type="number" class="form-control" min="0" max="3" name="1b1" value=""></td>
                            <td></td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td><input type="number" class="form-control" min="0" max="5" name="1b2" value=""></td>
                            <td></td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td><input type="number" class="form-control" min="0" max="4" name="1c" value=""></td>
                            <td></td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td><input type="number" class="form-control" min="0" max="2" name="1d" value=""></td>
                            <td></td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            ...
                            <td style="text-align: center">06</td>
                            <td><input type="number" class="form-control" min="0" max="6" name="2a1" value=""></td>
                            <td></td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td style="text-align: center">04</td>
                            <td><input type="number" class="form-control" min="0" max="4" value=""></td>
                            <td></td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            ...
                            <td style="text-align: center">05</td>
                            <td><input type="number" class="form-control" min="0" max="5" value=""></td>
                            <td></td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            ...
                            <td style="text-align: center">10</td>
                            <td><input type="number" class="form-control" min="0" max="10" value=""></td>
                            <td></td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            ...
                            <td><input type="number" class="form-control" min="0" max="1" value=""></td>
                            <td></td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            ...
                            <td style="text-align: center">03</td>
                            <td><input type="number" class="form-control" min="0" max="3" value=""></td>
                            <td></td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td style="text-align: center">02</td>
                            <td><input type="number" class="form-control" min="0" max="2" value=""></td>
                            <td></td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td><input type="number" class="form-control" min="0" max="8" value=""></td>
                            <td></td>
                        </tr>
                        <tr>
                            <td>
