                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><input type="number" class="form-control" min="0" max="10" name="1a" value=" {{ $my_temp_point->p1a }} "></td>
                        ...
                        <tr>
                            ...
                            <td><input type="number" class="form-control" min="0" max="3" name="1b1" value=" {{ $my_temp_point->p1b1 }} "></td>
                        ...
                        <tr>
                            ...
                            <td><input type="number" class="form-control" min="0" max="5" name="1b2" value=" {{ $my_temp_point->p1b2 }} "></td>
                        ...
                        <tr>
                            ...
                            <td><input type="number" class="form-control" min="0" max="4" name="1c" value=" {{ $my_temp_point->p1c }} "></td>
                        ...
                        <tr>
                            ...
                            <td><input type="number" class="form-control" min="0" max="2" name="1d" value=" {{ $my_temp_point->p1d }} "></td>
                        ...
                        <tr>
                            ...
                            <td style="text-align: center">06</td>
                            <td><input type="number" class="form-control" min="0" max="6" name="2a1" value=" {{ $my_temp_point->p2a1 }} "></td>
                        ...
                        <tr>
                            ...
                            <td style="text-align: center">04</td>
                            <td><input type="number" class="form-control" min="0" max="4" name="2a2" value=" {{ $my_temp_point->p2a2 }} "></td>
                        ...
                        <tr>
                            ...
                            <td style="text-align: center">05</td>
                            <td><input type="number" class="form-control" min="0" max="5" name="2b1" value=" {{ $my_temp_point->p2b1 }} "></td>
                        ...
                        <tr>
                            ...
                            <td style="text-align: center">05</td>
                            <td><input type="number" class="form-control" min="0" max="5" name="2b2" value=" {{ $my_temp_point->p2b2 }} "></td>
                        ...
                        <tr>
                            ...
                            <td style="text-align: center">05</td>
                            <td><input type="number" class="form-control" min="0" max="5" name="2b3" value=" {{ $my_temp_point->p2b3 }} "></td>
                        ...
                        <tr>
                            ...
                            <td style="text-align: center">10</td>
                            <td><input type="number" class="form-control" min="0" max="10" name="3a1" value=" {{ $my_temp_point->p3a1 }} "></td>
                        ...
                        <tr>
                            ...
                            <td style="text-align: center">05</td>
                            <td><input type="number" class="form-control" min="0" max="5" name="3a2" value=" {{ $my_temp_point->p3a2 }} "></td>
                        ...
                        <tr>
                            ...
                            <td style="text-align: center">04</td>
                            <td><input type="number" class="form-control" min="0" max="4" name="3b1" value="{{ $my_temp_point->p3b1 }}"></td>
                        ...
                        <tr>
                            ...
                            <td><input type="number" class="form-control" min="0" max="1" name="3b2" value="{{ $my_temp_point->p3b2 }}"></td>
                        ...
                        <tr>
                            ...
                            <td style="text-align: center">01</td>
                            <td><input type="number" class="form-control" min="0" max="1" name="3b3" value="{{ $my_temp_point->p3b3 }}"></td>
                        ...
                        <tr>
                            ...
                            <td style="text-align: center">04</td>
                            <td><input type="number" class="form-control" min="0" max="4" name="3c" value="{{ $my_temp_point->p3c }}"></td>
                        ...
                        <tr>
                            ...
                            <td style="text-align: center">05</td>
                            <td><input type="number" class="form-control" min="0" max="5" name="4a1" value="{{ $my_temp_point->p4a1 }}"></td>
                        ...
                        <tr>
                            ...
                            <td style="text-align: center">03</td>
                            <td><input type="number" class="form-control" min="0" max="3" name="4a2" value="{{ $my_temp_point->p4a2 }}"></td>
                        ...
                        <tr>
                            ...
                            <td style="text-align: center">02</td>
                            <td><input type="number" class="form-control" min="0" max="2" name="4a3" value="{{ $my_temp_point->p4a3 }}"></td>
                        ...
                        <tr>
                            ...
                            <td><input type="number" class="form-control" min="0" max="8" name="4b" value="{{ $my_temp_point->p4b }}"></td>
                        ...
                        <tr>
                            ...
                            <td style="text-align: center">02</td>
                            <td><input type="number" class="form-control" min="0" max="2" name="4c" value="{{ $my_temp_point->p4c }}"></td>
